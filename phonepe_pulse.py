...
if option == 'All India':
    ...
    with tab2:
        ...
        cursor.execute(
            f"SELECT State, SUM(Count) FROM agg_user WHERE Year = '{in_us_yr}' AND Quarter = '{in_us_qtr}' GROUP BY State;")
        ...
        cursor.execute(
            f"SELECT SUM(Count), AVG(Count) FROM agg_user WHERE Year = '{in_us_yr}' AND Quarter = '{in_us_qtr}';")
...
# ==============================================          /     State wise       /             ============================================== #
    ...
    with tab3:
        ...
        # Transaction Analysis bar chart query
        cursor.execute(
            f"SELECT Transaction_type, Transaction_amount FROM agg_trans WHERE State = '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
        ...
        # Transaction Analysis table query
        cursor.execute(
            f"SELECT Transaction_type, Transaction_count, Transaction_amount FROM agg_trans WHERE State = '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
        ...
        # Total Transaction Amount table query
        cursor.execute(
            f"SELECT SUM(Transaction_amount), AVG(Transaction_amount) FROM agg_trans WHERE State = '{st_tr_st}' AND Year = '{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
        ...
        # Total Transaction Count table query
        cursor.execute(
            f"SELECT SUM(Transaction_count), AVG(Transaction_count) FROM agg_trans WHERE State = '{st_tr_st}' AND Year ='{st_tr_yr}' AND Quarter = '{st_tr_qtr}';")
